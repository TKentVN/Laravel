<div class="bdf4dc" role="presentation">
            <div class="fctIrd" aria-hidden="true">
                <div class="PxpPTe dCgGDe" jscontroller="P9M9H" jsaction="rcuQ6b:npT2md">
                    <div id="logo" class="SSBsw" title="Google">
                        <div class="qZp31e" jsname="l4eHX">
                            <svg viewBox="0 0 74 37" width="198" height="37" preserveAspectRatio="xMinYMin" xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true">
                        ...
                        <div class="Bt4Beb"><span class="uOGS3 MKjtLc"></span><span class="uOGS3 YhRJlf"></span><span class="uOGS3 zTnKRb"></span>
                            <span
                                class="uOGS3 G5cT7b"></span><span class="uOGS3 LHvJZ"></span></div>
                    </div>
                </div>
            </div>
            <div id="view_container" class="JhUD8d SQNfcc" jscontroller="WFS13" jsaction="rcuQ6b:npT2md" jsmodel="Z7PiFb qFmk3b qbZ0Se nqpTHe YPPRX eV9nn Xu2csd hc6Ubd"
                ...
                <form class="RFjuSb bxPAYd k6Zj8d" jscontroller="gsfs7c" jsaction="click:v3HUwf(preventDefault=true|DPJEMd),sJqX4b(Cuz2Ue);LfGMDc:RbvWUd;h4C2te:NGpkv;mejaPb:WWkjY;Qj8j0c:hRLCTe;ZYWmgb:UHZ0U;azuPB:s57X0c;sPvj8e:XyQaue;rcuQ6b:WYd;EJh3N:.CLIENT;submit:.CLIENT;WMmLoc:.CLIENT;ms5v1:.CLIENT"
                    data-locale="vi" data-is-refreshable="" role="presentation" novalidate="">
                    <div class="hMxfuf">
                        <div>
                            <h1 class="sfYUmb" data-a11y-title-piece="" id="headingText" jsname="z6sL2b">Đăng nhập</h1>
                            <p class="FgbZLd" data-a11y-title-piece="" id="headingSubtext">Sử dụng Tài khoản Google của bạn</p>
                        </div>
                    </div>
                    <div class="mbekbe bxPAYd" role="presentation">
                        <div class="iUe6Pd Us7fWe JhUD8d" role="presentation">
                            <div class="RCum0c">
                                <div jscontroller="zB5w" jsaction="keydown:C9BaXe;YqO5N:di0fJ;O22p3e:fpfTEe;AHmuwe:Jt1EX;rcuQ6b:WYd;EJh3N:WYd"
                                    jsname="dWPKW" role="presentation" data-is-rendered="true">
                                    <div class="rFrNMe uIZQNc og3oZc sdJrJc Tyc9J" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV;"
                                        jsshadow="" jsname="Vsb5Ub">
                                        <div class="aCsJod oJeWuf">
                                            <div class="aXBtI">
                                                <div class="Xb9hP"><input type="email" class="whsOnd zHQkBf" jsname="YPqjbf" autocomplete="username"
                                                        spellcheck="false" tabindex="0" aria-label="Email hoặc điện thoại" name="identifier"
                                                        id="identifierId" dir="ltr" data-initial-dir="ltr" data-initial-value="">
                                                    <div
                                                        jsname="YRMmle" class="AxOyFc snByac" aria-hidden="true">Email hoặc điện thoại</div>
                                            </div>
                            ...
                            </div><input type="password" name="hiddenPassword" jsname="RHeR4d" class="yb9KU" tabindex="-1" aria-hidden="true">
                            <p
                                jsname="OZNMeb" aria-live="assertive"></p><button type="button" jsname="Cuz2Ue" class="uBOgn">Bạn quên địa chỉ email?</button>
                                <div
                                    jscontroller="YW9DL" jsname="Si5T8b" class="Pwyhu YY0nEe" jsaction="click:IMdg8d(A1U4Sb);rcuQ6b:jqIVcd"><img jsname="O9Milc" id="captchaimg"><img src="data:image/png;base64,"
                                        jsname="A1U4Sb" id="playCaptchaButton" class="XmqXzd" alt="Nghe và nhập những số bạn nghe thấy"
                                        tabindex="0">
                                    <audio jsname="CakGX" type="audio/wav" id="captchaAudio"></audio>
                                    <div jscontroller="zB5w" jsaction="keydown:C9BaXe;YqO5N:di0fJ;O22p3e:fpfTEe;AHmuwe:Jt1EX;rcuQ6b:WYd;EJh3N:WYd"
                                        jsname="CQRbLd" role="presentation" data-is-rendered="true">
                                        <div class="rFrNMe uIZQNc og3oZc sdJrJc Tyc9J" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV;"
                                            jsshadow="" jsname="Vsb5Ub">
                                            <div class="aCsJod oJeWuf">
                                                <div class="aXBtI">
                                                    <div class="Xb9hP"><input type="text" class="whsOnd zHQkBf" jsname="YPqjbf" autocomplete="off"
                                                            spellcheck="false" tabindex="0" aria-label="Gõ văn bản bạn nghe hoặc nhìn thấy"
                                                            name="ca" id="ca" dir="ltr" data-initial-dir="ltr" data-initial-value="">
                                                        <div
                                                            jsname="YRMmle" class="AxOyFc snByac" aria-hidden="true">Gõ văn bản bạn nghe hoặc nhìn thấy</div>
                                                </div>
                                                <div class="i9lrp mIZh1c"></div>
                        ...
                        </div><input jsname="SBlSod" type="hidden" name="ct" id="ct"></div>
            </div>
        </div>